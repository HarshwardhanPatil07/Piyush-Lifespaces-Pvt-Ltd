        ...
        <div className="text-center">
          ...
          >
            ...
            <a
              ...
              className="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6 hover:bg-opacity-30 transition-all duration-300 group"
            >
              <Mail className="h-8 w-8 text-white mx-auto mb-3 group-hover:scale-110 transition-transform duration-300" />
              <div className="text-white font-semibold">Email Us</div>
              <div className="text-blue-100 text-sm">info@piyushlifespaces.com</div>
            </a>
            ...
            >
              ...
              <div className="text-blue-100 text-sm">Fill out our form</div>
            </a>
          </motion.div>
        </div>
      </div>
